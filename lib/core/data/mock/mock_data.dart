...
/// Mock domain data shared across Home / Search / Filter / Library /
/// Book Detail / Author screens until the real backend API is wired up.
/// Split out of `core/models/book.dart` — that file defines the shapes,
...
class MockData {
  ...
  static final collections = <BookCollection>[
    ...
    BookCollection(
      ...
      emoji: '📱',
      gradient: AppGradients.coralPurple.colors,
