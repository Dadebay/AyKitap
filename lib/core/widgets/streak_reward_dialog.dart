...
class StreakRewardDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final message = isBalance
        ? StreakStrings.rewardBalanceMessage(reward.amount ?? 0, reward.streakDay)
        : StreakStrings.rewardSubscriptionMessage(reward.monthCount ?? 1, reward.streakDay);
    return Dialog(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Center(
                child: HugeIcon(
                  icon: isBalance ? HugeIcons.strokeRoundedCoins01 : HugeIcons.strokeRoundedCrown,
            ...
            Text(StreakStrings.rewardTitle, style: TextStyle(color: AppColors.white, fontSize: 19, fontWeight: FontWeight.w800)),
            const SizedBox(height: 10),
            Text(message, textAlign: TextAlign.center, style: TextStyle(color: AppColors.grey1, fontSize: 14, height: 1.4)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(StreakStrings.rewardCta, style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700)),
              ),
            ),
          ],
        ),
