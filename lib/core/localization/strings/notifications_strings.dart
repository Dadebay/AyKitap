...
class NotificationsStrings {
  ...
  static String get title =>
      t(tk: 'Bildirişler', ru: 'Уведомления', tr: 'Bildirimler');
  ...
  static String get newBookTime =>
      t(tk: '2 sag ozal', ru: '2 часа назад', tr: '2 saat önce');
  ...
  static String get streakTime =>
      t(tk: '5 sag ozal', ru: '5 часов назад', tr: '5 saat önce');
  ...
  static String get paymentTitle => t(
      tk: 'Töleg tassyklandy', ru: 'Платёж подтверждён', tr: 'Ödeme onaylandı');
  ...
  static String get paymentTime =>
      t(tk: '3 gün ozal', ru: '3 дня назад', tr: '3 gün önce');
}
