...
class AuthorStrings {
  ...
  static String get authorLabel =>
      t(tk: 'Ýazar', ru: 'Автор', tr: 'Yazar', en: 'Author');

  static String booksCountLabel(int count) => t(
      tk: '$count kitap',
      ru: '$count книг',
      tr: '$count kitap',
      en: '$count books');
  ...
  static String get readMore => t(
      tk: 'Dowamyny oka',
      ru: 'Читать далее',
      tr: 'Devamını oku',
      en: 'Read more');
  static String get allBooks => t(
      tk: 'Ähli kitaplary',
      ru: 'Все книги',
      tr: 'Tüm kitapları',
      en: 'All books');
  static String pagesLabel(int count) =>
      t(tk: '$count', ru: '$count', tr: '$count ', en: '$count');
  ...
  static String get sortByDate =>
      t(tk: 'Senesi boýunça', ru: 'По дате', tr: 'Tarihe göre', en: 'By date');
