...
class SettingsStrings {
  ...
  static String get logoutConfirm =>
      t(tk: 'Hawa, çyk', ru: 'Да, выйти', tr: 'Evet, çık');
  static String get deleteAccount =>
      t(tk: 'Hasaby poz', ru: 'Удалить аккаунт', tr: 'Hesabı sil');
  ...
  static String get appVersion =>
      t(tk: 'Aykitap v1.0.0', ru: 'Aykitap v1.0.0', tr: 'Aykitap v1.0.0');

  // widgets/contact_us_sheet.dart
  static String get contactTelegram =>
      t(tk: 'Telegram', ru: 'Telegram', tr: 'Telegram');
  static String get contactPhone =>
      t(tk: 'Telefon', ru: 'Телефон', tr: 'Telefon');
  static String get contactEmail =>
      t(tk: 'E-poçta', ru: 'Эл. почта', tr: 'E-posta');
