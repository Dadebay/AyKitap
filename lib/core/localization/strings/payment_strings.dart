...
class PaymentStrings {
  ...
  static String get paymentPageTitle =>
      t(tk: 'Töleg', ru: 'Оплата', tr: 'Ödeme');

  // book_purchase_screen.dart
  static String get purchaseTitle =>
      t(tk: 'Satyn alyş', ru: 'Покупка', tr: 'Satın alma');
  ...
  static String get balanceNotEnough => t(
      ...
      tr: 'Bakiye yetersiz');
  static String get bookPrice =>
      t(tk: 'Kitabyň bahasy', ru: 'Цена книги', tr: 'Kitabın fiyatı');
  static String get yourBalance =>
      t(tk: 'Balansyňyz', ru: 'Ваш баланс', tr: 'Bakiyeniz');
  static String get afterPurchase => t(
      tk: 'Satyn alandan soň', ru: 'После покупки', tr: 'Satın aldıktan sonra');
  static String get notEnough =>
      t(tk: 'Ýeterlik däl', ru: 'Недостаточно', tr: 'Yetersiz');
  ...
  static String get topUpBalance =>
      t(tk: 'Balans doldur', ru: 'Пополнить баланс', tr: 'Bakiye yükle');
  ...
  static String get plan3Months =>
      t(tk: '3 Aýlyk', ru: '3 месяца', tr: '3 Aylık');
  static String get plan6Months =>
      t(tk: '6 Aýlyk', ru: '6 месяцев', tr: '6 Aylık');
  ...
  static String planMonthsGeneric(int months) =>
      t(tk: '$months aýlyk', ru: '$months месяцев', tr: '$months aylık');
  ...
  static String get mostPopular =>
      t(tk: 'Iň meşhur', ru: 'Самый популярный', tr: 'En popüler');
  ...
  static String get subscriptionSuccessTitle =>
      t(tk: 'Gutlaýarys!', ru: 'Поздравляем!', tr: 'Tebrikler!');
  static String get subscriptionSuccessCta =>
      t(tk: 'Okap başlaýyn', ru: 'Начать читать', tr: 'Okumaya başla');
  static String get activeSubscription =>
      t(tk: 'Işjeň abunalyk', ru: 'Активная подписка', tr: 'Aktif abonelik');
  ...
  static String get selectBankTitle =>
      t(tk: 'Bank saýlaň', ru: 'Выберите банк', tr: 'Banka seçin');
  ...
  static String get payWithPromoCode =>
      t(tk: 'Promokod bilen', ru: 'По промокоду', tr: 'Promosyon koduyla');

  // balance_top_up.dart / widgets/top_up_amount_sheet.dart
  static String get topUpTitle =>
      t(tk: 'Balansy doldur', ru: 'Пополнить баланс', tr: 'Bakiye yükle');
  static String get topUpAmountTitle => t(
      tk: 'Näçe TMT dolduraly?',
      ru: 'На какую сумму TMT пополнить?',
      tr: 'Ne kadar TMT yükleyelim?');
  static String get topUpAmountHint =>
  ...
  static String get promoCodeHint =>
      t(tk: 'Promokod', ru: 'Промокод', tr: 'Promosyon kodu');
  static String get promoCodeApply =>
      t(tk: 'Ulan', ru: 'Применить', tr: 'Uygula');
