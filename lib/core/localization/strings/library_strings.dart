...
class LibraryStrings {
  ...
  static String get libraryTitle => t(
      tk: 'Kitap Tekjäm',
      ru: 'Моя библиотека',
      tr: 'Kitaplığım',
      en: 'My Bookshelf');
  static String get tabReading =>
      t(tk: 'Okaýanlarym', ru: 'Читаю', tr: 'Okuduklarım', en: 'Reading');
  static String get tabFinished => t(
      tk: 'Okap gutaranlarym',
      ru: 'Прочитанные',
      tr: 'Bitirdiklerim',
      en: 'Finished');
  static String get tabDownloaded => t(
      tk: 'Ýüklenenler',
      ru: 'Загруженные',
      tr: 'İndirilenler',
      en: 'Downloaded');
  static String get tabPurchased => t(
      tk: 'Satyn alynanlar',
      ru: 'Купленные',
      tr: 'Satın Alınanlar',
      en: 'Purchased');
  static String get tabFavorites =>
      t(tk: 'Halanlarym', ru: 'Избранные', tr: 'Favorilerim', en: 'Favorites');
  static String get tabOwnBooks => t(
      tk: 'Öz Kitaplarym',
      ru: 'Мои книги',
      tr: 'Kendi Kitaplarım',
      en: 'My Own Books');
  ...
  static String get emptyDownloadedSub => t(
      ...
      en: 'Download a book to read offline');
  ...
  static String get loginRequiredTitle => t(
      ...
      en: 'Sign in to see your bookshelf');
  ...
  static String get offlineBookUnavailable => t(
      ...
      en: 'This book hasn\'t been downloaded to your device');
  ...
  static String get deleteTitle => t(
      tk: 'Tekjeden poz',
      ru: 'Удалить с полки',
      tr: 'Raftan sil',
      en: 'Remove from shelf');
  static String get delete =>
      t(tk: 'Poz', ru: 'Удалить', tr: 'Sil', en: 'Remove');
  ...
  static String deleteFavoriteConfirm(String title) => t(
      tk: '«$title» Halanlarymdan aýrylar.',
      ru: '«$title» исчезнет из избранного.',
      tr: '«$title» favorilerimden kalkar.',
      en: '“$title” will be removed from Favorites.');
  ...
  static String get addFileSubtitle => t(
      ...
      en: 'Open files from your phone in Reader');
  static String get addedBooks => t(
      tk: 'Goşulan kitaplar',
      ru: 'Добавленные книги',
      tr: 'Eklenen kitaplar',
      en: 'Added books');
  ...
  static String get noInternetSnackbar => t(
      ...
      en: 'No internet yet');
  static String get noInternetTitle => t(
      tk: 'Internet ýok',
      ru: 'Нет интернета',
      tr: 'İnternet yok',
      en: 'No internet');
