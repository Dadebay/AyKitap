...
class ReaderStrings {
  ...
  static String get transitionScroll =>
      t(tk: 'Aşaklygyna', ru: 'Вниз', tr: 'Aşağı', en: 'Down');
  ...
  /// Turns the phone sideways for reading and keeps it there — see
  /// `setReaderLandscapeReading`. Worth its own switch because a phone whose
  /// system rotation lock is on can't be turned sideways by hand.
  static String get landscapeReadingTitle => t(
      tk: 'Ýatyk okamak',
      ru: 'Читать горизонтально',
      tr: 'Yatay okuma',
      en: 'Landscape reading');
