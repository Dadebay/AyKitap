...
class AuthStrings {
  ...
  static String get phoneHint =>
      t(tk: 'XX XX XX XX', ru: 'XX XX XX XX', tr: 'XX XX XX XX');

  static String get sendCodeButton =>
      t(tk: 'SMS kod ibermek', ru: 'Отправить SMS-код', tr: 'SMS kodu gönder');
  ...
  static String get termsSuffix =>
      t(tk: ' razylaşýarsyňyz.', ru: '.', tr: ' kabul etmiş olursunuz.');

  // ── OTP verify ───────────────────────────────────────────────────────
  static String get otpTitle =>
      t(tk: 'Kody giriziň', ru: 'Введите код', tr: 'Kodu girin');
  ...
  static String get confirmButton =>
      t(tk: 'Tassykla', ru: 'Подтвердить', tr: 'Onayla');
  ...
  // ── Name entry ───────────────────────────────────────────────────────
  static String get nameEntryTitle =>
      t(tk: 'Adyňyzy giriziň', ru: 'Введите ваше имя', tr: 'Adınızı girin');
