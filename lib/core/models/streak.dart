...
class StreakMonthSummary {
  ...
  const StreakMonthSummary(
      {required this.month,
      required this.pages,
      required this.minutes,
      required this.daysMet});

  factory StreakMonthSummary.fromJson(Map<String, dynamic> json) =>
      StreakMonthSummary(
...
StreakRewardType _rewardTypeFromJson(dynamic raw) => raw == 'SUBSCRIPTION'
    ? StreakRewardType.subscription
    : StreakRewardType.balance;
...
class StreakRewardRule {
  ...
  factory StreakRewardRule.fromJson(Map<String, dynamic> json) =>
      StreakRewardRule(
...
class StreakOverview {
  ...
  factory StreakOverview.fromJson(Map<String, dynamic> json) {
    ...
    return StreakOverview(
      ...
      week: (json['week'] as List? ?? const [])
          .map((e) => StreakWeekDay.fromJson(e as Map<String, dynamic>))
          .toList(),
      thisMonth: months['this_month'] != null
          ? StreakMonthSummary.fromJson(
              months['this_month'] as Map<String, dynamic>)
          : const StreakMonthSummary(
              month: '', pages: 0, minutes: 0, daysMet: 0),
      lastMonth: months['last_month'] != null
          ? StreakMonthSummary.fromJson(
              months['last_month'] as Map<String, dynamic>)
          : const StreakMonthSummary(
              month: '', pages: 0, minutes: 0, daysMet: 0),
      rewardRules: (json['reward_rules'] as List? ?? const [])
          .map((e) => StreakRewardRule.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
}
...
class StreakReportResult {
  ...
  const StreakReportResult(
      {required this.today,
      required this.currentStreak,
      required this.bestStreak,
      required this.rewards});

  factory StreakReportResult.fromJson(Map<String, dynamic> json) =>
      StreakReportResult(
        today: StreakDay.fromJson(json['today'] as Map<String, dynamic>),
        currentStreak: json['current_streak'] as int? ?? 0,
        bestStreak: json['best_streak'] as int? ?? 0,
        rewards: (json['rewards'] as List? ?? const [])
            .map((e) => StreakReward.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
}
...
class StreakHistoryPage {
  ...
  factory StreakHistoryPage.fromJson(Map<String, dynamic> json) =>
      StreakHistoryPage(
