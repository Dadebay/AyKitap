...
/// a separately purchased one remains available offline.
...
class _ReaderTabScreenState extends State<ReaderTabScreen> {
  ...
  Future<void> _openLastBook(LastReadBook last) async {
    await DownloadedFilesStore.instance.load();
    await BookAccessService.instance.load();
    if (!BookAccessService.instance.canRead(last.bookId)) return;
