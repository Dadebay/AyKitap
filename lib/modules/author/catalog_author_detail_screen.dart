...
class CatalogAuthorDetailScreen extends StatefulWidget {
  ...
  @override
  State<CatalogAuthorDetailScreen> createState() =>
      _CatalogAuthorDetailScreenState();
}
...
class _CatalogAuthorDetailScreenState extends State<CatalogAuthorDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      try {
        final books =
            await BookListApiService.listBooks(authorId: widget.authorId);
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(AuthorStrings.loadError,
                  textAlign: TextAlign.center,
                  style: TextStyle(color: AppColors.grey2, fontSize: 14)),
              const SizedBox(height: 12),
              TextButton(
                  onPressed: _load,
                  child: Text(AuthorStrings.retry,
                      style: TextStyle(
