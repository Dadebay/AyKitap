              ...
              child: Column(
                children: [
                  for (int i = 0; i < top.length; i++) ...[
                    _RankedBookTile(rank: i + 1, book: top[i], collectionId: collection.id),
                  ...
                  if (books.isNotEmpty)
                    Container(
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: () => context.pushFade(CatalogCollectionBooksScreen(title: collection.name, books: books, ranked: true, bannerImage: bannerImage)),
...
class _RankedBookTile extends StatelessWidget {
  ...
  const _RankedBookTile({required this.rank, required this.book, required this.collectionId});
